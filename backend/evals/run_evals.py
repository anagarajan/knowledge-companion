#!/usr/bin/env python3
"""
Comprehensive AI Evals for the Knowledge Companion RAG system.
...
def write_findings_report() -> None:
    ...
    lines: list[str] = []
    lines.append("# Knowledge Companion RAG — AI Evals Findings Report")
    ...
    report_path = Path("/Users/ashwinkumarnagarajan/knowledge-companion/backend/evals/findings.md")
...
def main() -> None:
    print("=" * 70)
    print("Knowledge Companion RAG — Comprehensive AI Evals")
